...
class Addstudent extends React.Component {
    ...
    Addstudent = () => {
        axios.post('https://localhost:7167/api/Student', { Name: this.state.Name, RollNo: this.state.RollNo, Class: this.state.Class, Address: this.state.Address, Gender: this.state.Gender })
            .then(json => {
